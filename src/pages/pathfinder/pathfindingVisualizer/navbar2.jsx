...
class NavBar extends Component {
  ...
  toggleOpenMaze =()=> this.setState({isOpenMaze:!this.state.isOpenMaze});
  toggleOpenSpeed =()=> this.setState({isOpenSpeed:!this.state.isOpenSpeed});
  render() {
    const menuClass = `dropdown-menu${this.state.isOpen ? " show" : ""}`;
    const menuClass2 = `dropdown-menu${this.state.isOpenMaze ? " show" : ""}`;
    const menuClass3 = `dropdown-menu${this.state.isOpenSpeed ? " show" : ""}`
    return (
      <nav className="navbar navbar-expand navbar-dark bg-dark">
        ...
        <div className="navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown">
              <div className="dropdown" onClick={this.toggleOpenMaze}>
                <button
                  className="btn btn-light dropdown-toggle"
                  type="button"
                  id="dropdownMenu1"
                ...
                <div className={menuClass2} aria-labelledby="dropdownMenu1">
                  <button
                    className="dropdown-item btn-light"
                    type="button"
            ...
            <li className="nav-item dropdown">
              <div className="dropdown" onClick={this.toggleOpenSpeed}>
                <button
                ...
                <div className={menuClass3}  aria-labelledby="dropdownMenu1">
                  <button
                    className="dropdown-item btn-light"
                    type="button"
